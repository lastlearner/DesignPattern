...
public class RoleAction extends CommonAction<Role>{
	 ...
	 * @return
	 */
	@Action(value="roleAction_showPermission")
	public String showPermission(){
		List<Permission> list = service.findPermissionsById(getModel().getId());
		list2json(list, new String[]{"roles"});
		return NONE;
	}
	@Action(value="roleAction_showMenu")
	public String showMenu(){
		List<Menu> list = service.showMenu(getModel().getId());
