...
public class WayBill {
	...
	public WayBill(String wayBillNum, Order order, String sendName, String sendMobile, String sendCompany,
			Area sendArea, String sendAddress, String recName, String recMobile, String recCompany, Area recArea,
			String recAddress, String sendProNum, String goodsType, String payTypeNum, Double weight, String remark,
			Integer num, String arriveCity, Integer feeitemnum, Double actlweit, String vol, String floadreqr,
			String wayBillType, Integer signStatus, String delTag) {
		super();
