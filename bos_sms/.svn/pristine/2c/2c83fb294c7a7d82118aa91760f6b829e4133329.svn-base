...
public class SmsUtils {
	public static void main(String[] args) {
		String msg = "尊敬的用户您好，本次获取的验证码为：4365，服务电话：4006184000";
		String ret = SmsUtils.sendSmsByWebService("15940041208", msg);
	...
	private static String userid = "at_1000";
	private static String pass = "itcastantao";
}
